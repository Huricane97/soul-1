          ...
          <div className='flex w-full items-center justify-center gap-2 buttons relative'>
            <div className='flex w-full justify-end items-center menu'>
              ...
              <a className='flex flex-col items-center gap-1' id='' href='/Guild'>
                <img className='w-[10px] h-[30px]' src='/assets/imgs/header/image.png' />
              ...
              <a className='flex flex-col items-center gap-1' id='' href='/RanksPerformance'>
                <img className='w-[10px] h-[30px]' src='/assets/imgs/header/image-2.png' />

              </a>
              <a className='flex flex-col items-center gap-1' id='' href='/Recruitment'>
                <img className='w-[10px] h-[30px]' src='/assets/imgs/header/image-3.png' />

              </a>
              <a className='flex flex-col items-center gap-1' id='' href='/GetReward'>
                <img className='w-[10px] h-[30px]' src='/assets/imgs/header/image-4.png' />

              </a>
              <a className='flex flex-col items-center gap-1' id='' href='/NFTs'>
                <img className='w-[10px] h-[30px]' src='/assets/imgs/header/image-5.png' />
